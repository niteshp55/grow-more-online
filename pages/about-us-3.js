              ...
              >
                <div className="icon-bx-wraper style-5 box-hover text-center m-b30">
                  ...
                  <div className="icon-content">
                    <h4 className="dlab-title m-b15">Strategy & Design</h4>
                    <p className="m-b20">
              ...
              >
                <div className="icon-bx-wraper style-5 box-hover active text-center m-b30">
                  ...
                  <div className="icon-content">
                    ...
                    <p className="m-b20">
                    We turn your ideas into a reality. and your website is placed on a "development server" where you get to watch the whole process, live.                    </p>
                    <Link href="services-3">
                      <a className="btn btn-outline-primary">
                        <i className="fa fa-angle-right"></i>
                      </a>
