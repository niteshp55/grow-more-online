					...
					<div className="col-xl-8 col-lg-8 m-b50">
						<div className="dlab-blog style-1 bg-white text-center m-b50">
							<div className="dlab-media dlab-img-effect zoom">
								<a href="blog-details-1.html"><img src="images/blog/default/thum1.jpg" alt=""/></a>
							</div>
							<div className="dlab-info">
								<h4 className="dlab-title">
									<a href="blog-details-1.html">Fusce sem ligula, imperdiet sed nisi sit amet, euismod posuere dolor. Vestibulum in ante ut tortor eleifend venenatis.</a>
								</h4>
						...
						<div className="dlab-blog style-1 bg-white text-center m-b50">
							...
							<div className="dlab-info">
								<h4 className="dlab-title">
									<a href="blog-details-1.html">Quisque egestas iaculis felis eget placerat ut pulvinar mi elitauctor nec.</a>
								</h4>
								<p className="m-b0">Sed auctor magna lacus, in placerat nisl sollicitudin ut. Morbi feugiat ante velit, eget convallis arcu iaculis vel. Fusce in rhoncus quam. Integer dolor arcu, ullamcorper sed auctor vitae, porttitor quis erat. Donec sit amet semper massa.</p>
								<div className="dlab-meta meta-bottom">
									<ul>
						...
						<div className="dlab-blog style-1 bg-white text-center m-b50">
							...
							<div className="dlab-info">
								<h4 className="dlab-title">
									<a href="blog-details-1.html">Quisque sem tortor, convallis in arcu eu, accumsan finibus massa donec et sapien risus.</a>
								</h4>
								<p className="m-b0">Sed auctor magna lacus, in placerat nisl sollicitudin ut. Morbi feugiat ante velit, eget convallis arcu iaculis vel. Fusce in rhoncus quam. Integer dolor arcu, ullamcorper sed auctor vitae, porttitor quis erat. Donec sit amet semper massa.</p>
								<div className="dlab-meta meta-bottom">
									<ul>
                            ...
                            <div className="widget recent-posts-entry">
                                ...
                                <div className="widget-post-bx">
                                    <div className="widget-post clearfix">
                                        ...
                                        <div className="dlab-info">
											<h4 className="title"><a href="blog-details-1.html">Fusce mollis felis quis tristique</a></h4>
                                    ...
                                    <div className="widget-post clearfix">
                                        <div className="dlab-media"> 
											<a href="blog-details-1.html"><img src="images/blog/recent-blog/pic2.jpg" alt=""/> </a>
										</div>
                                        <div className="dlab-info">
											<h4 className="title"><a href="blog-details-1.html">Fusce mollis felis quis tristique</a></h4>
											<div className="dlab-meta">
                                    ...
                                    <div className="widget-post clearfix">
                                        <div className="dlab-media"> 
											<a href="blog-details-1.html"><img src="images/blog/recent-blog/pic3.jpg" alt=""/> </a>
										</div>
                                        <div className="dlab-info">
											<h4 className="title"><a href="blog-details-1.html">Fusce mollis felis quis tristique</a></h4>
                                            <div className="dlab-meta">
			...
			<div className="container">
				<div className="row action-box style-1 align-items-center">
					...
					<div className="col-xl-5 col-lg-4 col-md-4 text-right m-b30 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s">
						<a href="contact-us-1.html" className="btn btn-link d-inline-flex align-items-center"><i className="fa fa-angle-right m-r10"></i>Join Now</a>
					</div>
				</div>
			</div>
		</section>
