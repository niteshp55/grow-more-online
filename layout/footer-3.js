					...
					<div className="col-xl-3 col-lg-12 col-md-4 col-sm-6 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
                        <div className="widget widget_about">
							<div className="footer-logo">
								<a href="/"><img src="images/gmo-white.png" alt=""/></a> 
							</div>
							<p>Enabling companies to flow with the change in order to grow</p>
						...
						<div className="widget widget_getintuch">
							...
							<ul>
								<li>
									...
									<span>+91 992-210-3897<br/>+91 917-287-6789</span> 
								</li>
								<li>
									<i className="fa fa-envelope gradient"></i> 
									<span>growmoreonlinee@gmail.com <br/>niteshpadghan682@gmail.com</span>
								</li>
								<li>
